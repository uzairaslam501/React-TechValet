    ...
    <>
            ...
            >
              <div>
                ...
                <div className="mt-4">
                  ...
                  <Button variant="primary" size="lg" className="border-1 border-dark px-4 py-2">
                    Offering Service
                  </Button>
                </div>
              </div>
      ...
      <Row style={{position: "relative"}}>
        <Container fluid className="bg-white pt-5">
            ...
            {/* What We Do */}
            <Row className="mb-5 px-5" style={{ position: "relative", top: "25%" }}>
              <Container style={{backgroundColor: "#f7f7f8", borderRadius: "15px"}}>

                <Container style={{padding: "10rem 0 1rem 5rem"}}>
                  <Row>
                      <h4 className="text-center text-danger">* At the end of the appointment, our Valets will provide you with a 1-page overview of the solution, 
                        so you can use it any time you run into the same roadblock in the future!</h4>
                  </Row>
                  ...
                  <Row className="pt-5">
                    <Col 
                      ...
                      sm={12}
                    >
                      <h1 className="fw-bold mb-3" style={{fontSize: "3rem"}}>What we Do</h1>
                      <h4 className="mt-5" style={{lineHeight: "2.5rem"}}>We connect you with people who are IT savvy, so they can help you solve your 
                            techheadaches, quickly, at an affordable price, and at a time that's convenient for you.
                      </h4> 
                    ...
                    >
                      <img 
                      src={whatWeDoImage} alt="what-we-do-image" />
                    </Col>
            ...
            <Container style={{position: "relative", bottom: "65%"}}>
              ...
              <Row className="mt-5 px-5">            
                <Col style={{ backgroundColor: "#000000", borderRadius: "15px"}}
                  xl={12}
                  lg={12}
                  md={12}
                  sm={12}
